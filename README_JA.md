...
<p align="center">
  📌 <a href="http://claw.newcode.top/">オンラインで読む</a> | 🚀 <a href="https://github.com/datawhalechina/easy-vibe">Vibe Coding も学びたい？</a>
</p>
...
**本プロジェクトは 6 つの中核モジュールで構成されています:**

1. **Clawを迎える（ユーザー編）**: 11 章 + 7 つの付録で構成され、導入（第 1-3 章）、コア設定（第 4-6 章）、運用と拡張（第 7-9 章）、セキュリティとクライアント（第 10-11 章）をカバーします
2. **Clawを構築する（開発編）**: Runtime、ツール、ゲートウェイ、セキュリティ、カスタマイズ方針までを系統立てて解説します
3. **AI Agent システム**: 記憶、協調、実行ループ、CLI / MCP 分担、Skills による経験蓄積など、Agent の中核能力を扱います
4. **LangChain 深掘りガイド**: Runnable、LCEL、Tool Calling、RAG、Agent、LangGraph を軸に、フレームワーク実装を段階的に整理します
5. **LLM アーキテクチャ解析**: モデル能力の境界、推論チェーン、コンテキスト機構などの基礎テーマを扱います
6. **AI オープンソース精選**: Agent ランタイム、安全境界、周辺インフラとして参考になる OSS を追跡します
...
- Agent 能力を理解したい方: 「AI Agent システム」「LangChain 深掘りガイド」「LLM アーキテクチャ解析」を並行して読むのがおすすめです。現在、AI Agent は第 7 章まで、LangChain は第 VIII 篇まで更新されています

## 🔥 最新情報

- **[2026-04-20]** ✅ 現在の進捗: AI Agent システムは第 7 章まで、LangChain 深掘りガイドは第 VIII 篇まで公開済みで、この README の概要も最新構成に合わせて更新
- **[2026-04-20]** ✅ AI Agent システム第 7 章「Skills システム設計」を追加。OpenClaw、Claude Code、Hermes Agent がどのように再利用可能な経験を蓄積するかを整理
- **[2026-04-19]** ✅ AI Agent システム第 6 章「MCP vs CLI」を追加。OpenClaw、Claude Code、Hermes Agent における CLI と MCP の役割分担を比較
- **[2026-04-18]** ✅ LangChain 深掘りガイド第 VIII 篇を追加。LangSmith、LangGraph、フレームワーク比較、次の学習ルートを補完
- **[2026-04-18]** ✅ LangChain 深掘りガイド第 VII 篇を追加。FastAPI + RAG + Memory を組み合わせたナレッジベースアシスタント実践を公開
- **[2026-04-18]** ✅ LangChain 深掘りガイド第 VI 篇を追加。Agents、Tools、ReAct、`create_agent`、middleware を整理
- **[2026-04-18]** ✅ LangChain 深掘りガイド第 V 篇を追加。RAG、ドキュメント読み込み、Embedding、Vector Store、Retriever を体系化
- **[2026-04-18]** ✅ LangChain 深掘りガイド第 IV 篇を追加。Memory、会話履歴管理、要約メモリを整理
