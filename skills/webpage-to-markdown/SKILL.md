...
description: 爬取网页内容并生成结构化的 Markdown 文档，支持可选的深度分析。Use when user asks to crawl/scrape/fetch a webpage, convert HTML to Markdown, save a web article as .md, or analyze web content. Triggers on keywords like "爬取", "抓取", "网页转Markdown", "保存网页", "解析网页", "生成MD文档".
---
