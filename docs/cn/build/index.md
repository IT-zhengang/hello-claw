...
### 2.3 第三板块：AI Agent智能体

这一板块聚焦具体的 Agent 核心能力设计，优先讨论记忆、协作、自治、长期运行等智能体级问题。

#### 第11章：记忆系统设计——让 Agent 真正“记住”

- **OpenClaw / Droid / Hermes 对比**：三种记忆架构哲学如何取舍
  - 文件即记忆：为什么透明和可控如此重要
  - 上下文工程：为什么 Token 预算管理本身就是架构能力
  - 情景记忆：如何把经验沉淀成可复用的 Skills

### 2.4 第四板块：AI大模型架构解析

这一板块将用于承接模型能力边界、推理链路、上下文机制、多模态架构等内容，当前先预留分类位。

### 2.5 第五板块：创造你自己的

这一板块聚焦"自己动手定制 OpenClaw"。这里的阅读节奏和前两板块不太一样：

- 第 1-11 章主要是在帮你建立系统视角，先看清 Agent Loop、提示词、工具、网关、记忆系统以及不同方案的取舍；
...
如果你已经有一些使用经验，想知道"还有什么其他可能"，先看第8-10章的替代方案，再进入“AI Agent智能体”分类下的第11章。这样更容易把系统取舍和智能体能力设计放到同一张图里理解。
...
- [第11章：记忆系统设计](./chapter11/index.md) —— 对比三种主流记忆架构，理解“会记住”到底意味着什么
