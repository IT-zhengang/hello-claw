...
![飞书开放平台首页](../../../static/adopt/chapter4/images/lark.png)
...
![飞书应用凭证页面](../../../static/adopt/chapter4/images/lark-credential.png)

### 第四步：启用机器人能力

进入"添加应用能力" → "机器人"，点击"添加"。

![添加应用能力页面](../../../static/adopt/chapter4/images/lark-app.png)
...
![飞书权限管理页面](../../../static/adopt/chapter4/images/lark-authentication.png)
...
![版本管理与发布页面](../../../static/adopt/chapter4/images/lark-version.png)
...
![事件与回调页面](../../../static/adopt/chapter4/images/lark-event.png)
...
![飞书配对码提示界面](../../../static/adopt/chapter4/images/lark-pairing.jpg)
...
![应用审核页面](../../../static/adopt/chapter4/images/lark-review.png)
