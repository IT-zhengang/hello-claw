...
| **🧠 第五层：AI大模型架构解析** | | |
| 图解导读：从模型到 Agent、MCP 与 Memory | 用 7 张图先建立模型、Agent、Workflow、Memory 与选型问题的整体地图 | ✅ |
| **🟡 第六层：从原理到实战** | | |
...
| 章节 | 内容简介 | 状态 |
| ---- | ---- | ---- |
| **写在开头** | **为什么要单独追踪值得借鉴的 Agent 基础设施项目** | ✅ |
| 第一篇：OpenSandbox | 一个围绕安全执行、浏览器自动化与远程开发环境设计的四层沙箱平台 | ✅ |
